...
public class BounceDamageContext implements IDamageContext {
    ...
    public BounceDamageContext(World world) {
    ...
    public IDamageContext setBounceTicks(int bounceTicks) {
        this.bounceTicks = bounceTicks;
        return this;
    }
}
