...
import net.vinh.library_of_silence.systems.rendering.particle.Easing;
import net.vinh.library_of_silence.systems.screenshake.PositionedScreenshakeInstance;

public class PositionedScreenshakePacket extends ScreenshakePacket {

	public static final Identifier ID = new Identifier("silentlibrary", "positionedscreenshake");
